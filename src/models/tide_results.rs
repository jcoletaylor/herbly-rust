...
pub struct HerbDosage {
    ...
    pub dosage: Option<String>,
    pub herb_dosage_type: HerbDosageType,
}
...
pub struct HerbProperty {
    ...
    pub herb_property_type: HerbPropertyType,
    pub precedence_type: PrecedenceType,
}
...
pub struct Herb {
    ...
    pub common_english: Option<String>,
    pub herb_category: String,
    pub herb_properties: Option<Vec<HerbProperty>>,
    pub herb_dosages: Option<Vec<HerbDosage>>,
    pub herb_actions: Option<Vec<HerbAction>>,
    pub herb_warnings: Option<Vec<HerbWarning>>,
    pub herb_notes: Option<Vec<HerbNote>>,
    pub herb_combination_herbs: Option<Vec<HerbCombinationHerb>>,
    pub herb_combinations: Option<Vec<HerbCombination>>,
}
